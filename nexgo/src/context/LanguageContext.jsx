...
const translations = {
  en: {
    ...
    services: "Services",
    about: "About Us",
    heroTitle: "Delicious Burgers Delivered to Your Doorstep",
    heroSubtitle: "Order from your favorite Restaurant",
  ...
  fr: {
    ...
    services: "Services",
    about: "À Propos",
    heroTitle: "De délicieux burgers livrés à votre porte",
    heroSubtitle: "Commandez dans votre restaurant préféré",
  ...
  es: {
    ...
    heroTitle: "Deliciosas hamburguesas entregadas en tu puerta",
    heroSubtitle: "Ordena en tu restaurante favorito",
